    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://192.99.169.49:8080/login",params);
                if(json != null){
                    try{
            ...
            public void onClick(View view) {
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("http://192.99.169.49:8080/api/resetpass", params);
                                ...
                                if(json.getBoolean("res")){
                                    ...
                                    cont_code.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            JSONObject json = sr.getJSON("http://192.99.169.49:8080/api/resetpass/chg", params);
